function varargout = SolutionBoostTopology(varargin)
% SOLUTIONboostTOPOLOGY MATLAB code for SolutionboostTopology.fig
%      SOLUTIONboostTOPOLOGY, by itself, creates a new SOLUTIONboostTOPOLOGY or raises the existing
%      singleton*.
%
%      H = SOLUTIONboostTOPOLOGY returns the handle to a new SOLUTIONboostTOPOLOGY or the handle to
%      the existing singleton*.
%
%      SOLUTIONboostTOPOLOGY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SOLUTIONboostTOPOLOGY.M with the given input arguments.
%
%      SOLUTIONboostTOPOLOGY('Property','Value',...) creates a new SOLUTIONboostTOPOLOGY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SolutionboostTopology_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SolutionboostTopology_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SolutionboostTopology
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @SolutionBoostTopology_OpeningFcn, ...
                   'gui_OutputFcn',  @SolutionBoostTopology_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SolutionboostTopology is made visible.
function SolutionBoostTopology_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SolutionboostTopology (see VARARGIN)

% Choose default command line output for SolutionboostTopology
...
%Photos ON/OFF
booston=imread('Boost_ON.jpg');
boostoff=imread('Boost_OFF.jpg');
...
% UIWAIT makes SolutionboostTopology wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SolutionBoostTopology_OutputFcn(hObject, eventdata, handles) 
