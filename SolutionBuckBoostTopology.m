function varargout = SolutionBuckBoostTopology(varargin)
% SOLUTIONbuckboostTOPOLOGY MATLAB code for SolutionbuckboostTopology.fig
%      SOLUTIONbuckboostTOPOLOGY, by itself, creates a new SOLUTIONbuckboostTOPOLOGY or raises the existing
%      singleton*.
%
%      H = SOLUTIONbuckboostTOPOLOGY returns the handle to a new SOLUTIONbuckboostTOPOLOGY or the handle to
%      the existing singleton*.
%
%      SOLUTIONbuckboostTOPOLOGY('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SOLUTIONbuckboostTOPOLOGY.M with the given input arguments.
%
%      SOLUTIONbuckboostTOPOLOGY('Property','Value',...) creates a new SOLUTIONbuckboostTOPOLOGY or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SolutionbuckboostTopology_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SolutionbuckboostTopology_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SolutionbuckboostTopology
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @SolutionBuckBoostTopology_OpeningFcn, ...
                   'gui_OutputFcn',  @SolutionBuckBoostTopology_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before SolutionbuckboostTopology is made visible.
function SolutionBuckBoostTopology_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SolutionbuckboostTopology (see VARARGIN)

% Choose default command line output for SolutionbuckboostTopology
...
%Photos ON/OFF
buckbooston=imread('Buck-boost ON.jpg');
buckboostoff=imread('Buck-boost OFF.jpg');
...
% UIWAIT makes SolutionbuckboostTopology wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SolutionBuckBoostTopology_OutputFcn(hObject, eventdata, handles) 
